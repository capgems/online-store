...
import com.epam.store.domain.ProductCategory;
import com.epam.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.epam.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
